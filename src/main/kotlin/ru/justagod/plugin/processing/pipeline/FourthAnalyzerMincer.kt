 ...
 * }
 * ```
 * Our goal to eliminate synthetic method that will be generated by javac and assign to its server side
 *
 * Another one
 * ```java
 * class Bar {
 ...
 * }
 * ```
 * Our goal to eliminate anonymous class that will be generated by javac and assign to its server side
 */
