...
object IntToLongInstruction : BytecodeInstruction() {
    override fun accept(mv: VariablesManager) {
...
class FakePopInstruction(private val type: TypeReference) : BytecodeInstruction() {
    override fun accept(mv: VariablesManager) {
    }
...
object LongCompareInstruction : BytecodeInstruction() {
    override fun accept(mv: VariablesManager) {
...
class ThrowInstruction(private val exceptionType: ClassTypeReference) : BytecodeInstruction() {
    ...
    override fun transformStack(stack: BytecodeStack) {
        stack.removeValue(exceptionType)
    }
